            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed inset-0 m-auto h-fit w-full max-w-md overflow-hidden rounded-3xl border border-white/20 bg-black/80 p-1 shadow-2xl backdrop-blur-2xl z-[101] pointer-events-auto"
                        style={{
